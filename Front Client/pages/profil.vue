...
export default {
  ...
  computed: {
    name: {
      ...
      set (value) {
        this.$store.dispatch('user/updateData', { token: this.$auth.getToken('local'), _id: this.$auth.user.id, firstName: value })
      }
    },
    ...
    surname: {
      ...
      set (value) {
        this.$store.dispatch('user/updateData', { token: this.$auth.getToken('local'), _id: this.$auth.user.id, lastName: value })
      }
    },
    ...
    phone: {
      ...
      set (value) {
        this.$store.dispatch('user/updateData', { token: this.$auth.getToken('local'), _id: this.$auth.user.id, phone: value })
      }
    },
    ...
    mail: {
      ...
      set (value) {
        this.$store.dispatch('user/updateData', { token: this.$auth.getToken('local'), _id: this.$auth.user.id, email: value })
      }
    },
    ...
    avatar: {
      ...
      set (value) {
        this.$store.dispatch('user/updateData', { token: this.$auth.getToken('local'), _id: this.$auth.user.id, avatar: value })
      }
    }
  },
  mounted () {
